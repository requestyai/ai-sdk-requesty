...
describe('doGenerate', () => {
  const server = new JsonTestServer('https://requesty.ai/api/v1/completions');
  ...
  it('should extract logprobs', async () => {
    ...
    const provider = createRequesty({ apiKey: 'test-api-key' });
    ...
    expect(response.logprobs).toStrictEqual(
      mapRequestyCompletionLogProbs(TEST_LOGPROBS),
    );
  });
  ...
  it('should pass the models array when provided', async () => {
    ...
    const customModel = provider.completion('openai/gpt-4o', {
      models: ['openai/gpt-4', 'anthropic/claude-3-5-haiku-latest'],
    });
...
describe('doStream', () => {
  const server = new StreamingTestServer(
    'https://requesty.ai/api/v1/completions',
  );
  ...
  it('should stream text deltas', async () => {
    ...
    expect(await convertReadableStreamToArray(stream)).toStrictEqual([
      ...
      { type: 'text-delta', textDelta: '' },
      {
        type: 'finish',
        finishReason: 'stop',
        logprobs: mapRequestyCompletionLogProbs(TEST_LOGPROBS),
  ...
  it('should handle error stream parts', async () => {
    server.responseChunks = [
      `data: {"error":{"message": "The server had an error processing your request. Sorry about that! You can retry your request, or contact us through our ` +
        `help center at help.requesty.com if you keep seeing this error.","type":"server_error","param":null,"code":null}}\n\n`,
      'data: [DONE]\n\n',
    ];
    ...
    expect(await convertReadableStreamToArray(stream)).toStrictEqual([
      {
        ...
        error: {
          message:
            ...
            'help.requesty.com if you keep seeing this error.',
          type: 'server_error',
          code: null,
          param: null,
        },
