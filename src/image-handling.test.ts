...
describe('Image Handling', () => {
  ...
  it('should handle raw base64 strings', () => {
    ...
    expect(imageUrl).toContain('iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==');
  });
  ...
  it('should handle HTTP URLs', () => {
    ...
    expect((result[0].content as any)[0].image_url.url).toBe('https://example.com/image.jpg');
  });
